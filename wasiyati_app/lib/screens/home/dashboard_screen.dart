...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
  ...
  void initState() {
    super.initState();
    // Data loads automatically via real-time Firestore streams in providers
  }
  ...
  Widget build(BuildContext context) {
    ...
    final trigger = ref.watch(triggerProvider).valueOrNull;
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  // Top row with greeting + notification bell
                  Row(
                    children: [
                      Expanded(
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                trigger != null
                                    ? '${trigger.daysRemaining < 0 ? 0 : trigger.daysRemaining} ${s.get('days_remaining')}'
                                    : '— ${s.get('days_remaining')}',
                                style: WasiyatiTypography.caption,
                              ),
                            ],
                          ),
                        ),
                        if (trigger != null && trigger.checkInDeadline != null)
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.end,
                            children: [
                              Text(
                                _formatMonthDay(trigger.checkInDeadline!),
                                style:
                              ...
                              Text('${trigger.checkInDeadline!.year}', style: WasiyatiTypography.caption),
                            ],
                          )
                        else
                          Column(
                            ...
                            children: [
                              ...
                              Text('—', style: WasiyatiTypography.caption),
                            ],
                          ),
                      ],
                    ),
